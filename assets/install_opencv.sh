...
sudo apt install python-pip python3-pip unzip build-essential cmake pkg-config libjpeg8-dev libtiff5-dev libjasper-dev libpng16-dev libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libxvidcore-dev libx264-dev libatlas-base-dev gfortran python3.5-dev libtesseract3 libtesseract-dev liblept5 libleptonica-dev
